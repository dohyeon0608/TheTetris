...
execute if score level main matches 4 run scoreboard players set drop_time main 3
execute if score level main matches 5 run scoreboard players set drop_time main 4
execute if score level main matches 6 run scoreboard players set drop_time main 5
