...
execute as @a if entity @s[x=-64,y=-38,z=18,dx=-2,dy=0,dz=1] run function game/camera_setting
execute as @a if entity @s[x=-64,y=-38,z=18,dx=-2,dy=0,dz=1] positioned 6 -41 9 run function tetris_bgm/play
execute as @a if entity @s[x=-64,y=-38,z=18,dx=-2,dy=0,dz=1] run tp 6 -32 11 270 0
